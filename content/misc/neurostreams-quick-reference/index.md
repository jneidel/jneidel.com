...
| <a href="/documents/neurostreams/katalog-en/Blood_pressure_lock_opener-Blutdruck-Schleusenöffner.pdf" target=_blank>Blood pressure</a> <a href="https://www.neurostreams.de/produkte/blutdruck-senken-ohne-medikamente/#aff=jneidel" target=_blank>lock opener</a> <span class="text-xs">(Blutdruck-Schleusenöffner)</span> | Lowering blood pressure | When needed | <span class="text-xl"><abbr class="no-underline" title="Eyes closed">:see_no_evil:</abbr>, <abbr class="no-underline" title="Headphones are recommended">:headphone:</abbr>/<abbr class="no-underline" title="Spakers can be used">:speaker:</abbr>, <abbr class="no-underline" title="Active listening">:person_in_lotus_position:</abbr> <abbr class="no-underline" title="Lie down or get comfortable">:bed:</abbr> |
