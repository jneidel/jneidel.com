...
summary: "My Software Developer CV."
tags:
date: 2025-12-01
excludeRss: true
nonOrgSource: true
...
English CV
{{</button>}}
- {{<button href="https://jneidel.de/about/cv/cv.pdf">}}
German CV
{{</button>}}
...
and directing a team of developers, PMs, QA and
other internal and external stakeholders.) I delivered
quality solutions and critical bug-fixes in a timely
manner. While doing so I always bring my own initiatives to the table that improve or automate process
and the environment, the technical docs and the developer experience.

The source for my CV is [this git repo](https://github.com/jneidel/cv).
